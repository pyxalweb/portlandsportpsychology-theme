...
add_action('wp_enqueue_scripts', 'theme_files', 10);
...
add_action('after_setup_theme', 'register_navigation', 20);
...
add_filter('nav_menu_css_class', 'add_menu_list_item_class', 20, 3);
...
add_filter( 'nav_menu_link_attributes', 'add_menu_link_class', 20, 3 );
